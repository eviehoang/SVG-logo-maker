...
function pickShape(response) {
    ...
    if (response.shape === 'Square') {
        let chosenShape = new square(response.shapeColor, response.text, response.textColor);
    ...
    if (response.shape === 'Triangle') {
        let chosenShape = new triangle(response.shapeColor, response.text, response.textColor);
        return chosenShape.render()
    }
};
