...
describe ('this square', () =>{
    it('should return the logo with the shape, shape color, and text color the user chose.', () =>{
        ...
        expect(SQUARE.render()).toEqual(
            `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><rect width="300" height="100" fill="#000000"/><text x="50%" y="50%" class="Rrrrr" fill="#FFFFFF" text-anchor="middle">PIN</text></svg>`
        )
    })
});
